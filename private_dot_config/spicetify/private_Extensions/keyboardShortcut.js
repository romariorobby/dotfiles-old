...
(function KeyboardShortcut() {
    ...
    registerBind("TAB", false, false, false, rotateSidebarDown);
    registerBind("TAB", false, true, false, rotateSidebarUp);

    // Ctrl + Q to open Queue page
    registerBind("Q", true, false, false, clickQueueButton);

    // Ctrl + n to open Queue page
    registerBind("N", true, false, false, clickNextButton);
    // registerBind("P", true, false, false, clickPlayButton);
    registerBind("P", true, false, false, clickPrevButton);
