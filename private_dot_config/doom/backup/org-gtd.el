;;; package --- This package provides GTD functionality to ORGMODE out of the box, with no extra configuration required (unless you want them)
;;; Code:
(defvar org-gtd-folder (expand-file-name "~/Dropbox/org/gtd/" org-directory))
(defvar org-projects-folder (file-name-directory "~/Dropbox/org/gtd/projtodos.org"))
